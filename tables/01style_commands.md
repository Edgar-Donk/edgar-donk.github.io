...
| element_create(elementname, etype, *args, **kw) | creates a new element in the current theme |
...
| theme_settings(themename, settings) | temporarily sets current theme to specified settings |
